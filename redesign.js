...
(() => {
 ...
 home.innerHTML="<div class=\"atlas-home-title\"><div><p class=\"atlas-eyebrow\">武汉 · 恩施 · 宜昌</p><h1>峡谷之间,江声不绝</h1></div><span class=\"atlas-edition\">武汉·恩施·宜昌 / 2026<br>旅行手册</span></div><div class=\"atlas-cover\"><img src=\"assets/cover.jpg\" alt=\"武汉·恩施·宜昌旅行封面\"><div class=\"atlas-cover-shade\"></div><div class=\"atlas-cover-copy\"><p>武汉 · 恩施 · 宜昌</p><h2>武汉·恩施·宜昌<br><em>峡谷之间,江声不绝</em></h2><span>从长江畔的城市出发,一路向西深入喀斯特峡谷腹地,再顺江东下,在三峡水利工程前收束这趟旅程。</span><a class=\"atlas-primary\" href=\"#route\">翻开7天行程 <span>↗</span></a></div><div class=\"atlas-cover-caption\">2026-10-01 — 2026-10-07<span>7天6晚</span></div></div><div class=\"atlas-quickline\"><div><b>07</b><span>天的旅行安排</span></div><div><b>06</b><span>晚的城市停留</span></div><div><b>08</b><span>个随行章节</span></div><button class=\"atlas-trip-open\">进入旅行模式 <span>↗</span><small>路线 · 地图 · 摄影 · 记账</small></button></div><div class=\"atlas-section-title\"><h2>每天的旅行书签</h2><span>点一天，展开详细安排</span></div><div class=\"atlas-day-list\"></div><div class=\"atlas-bottom-note\"><span>TRAVEL FIELD NOTES</span><p>内容与图片可离线阅读；导航和外部服务需联网。</p><a href=\"#booking\">检查行李与预约 ↗</a></div>";
 main.prepend(home);
